      ...
      <tfoot style="background-color: #ecf6fb">
        <tr class="filter">
          ...
          <td style="border-top: 1px solid #a0d0eb; border-bottom: 1px solid #a0d0eb;">
            <a href="#" v-if="serverDraft.read" class="list-action-enable action-enabled" @click="toggleDraftRead"><i
                      class="icon icon-check"></i></a>
            <a href="#" v-if="!serverDraft.read" class="list-action-enable action-disabled" @click="toggleDraftRead"><i
                      class="icon icon-times"></i></a>
          </td>
          <td style="border-top: 1px solid #a0d0eb; border-bottom: 1px solid #a0d0eb;">
            <a href="#" v-if="serverDraft.write" class="list-action-enable action-enabled" @click="toggleDraftWrite"><i
                      class="icon icon-check"></i></a>
            <a href="#" v-if="!serverDraft.write" class="list-action-enable action-disabled"
               @click="toggleDraftWrite"><i class="icon icon-times"></i></a>
          </td>
          <td style="border-top: 1px solid #a0d0eb; border-bottom: 1px solid #a0d0eb;">
          ...
          <td class="filter" style=" border-top: 1px solid #a0d0eb; border-bottom: 1px solid #a0d0eb;">
            <button type="submit" class="btn btn-default" @click="addServer"><i
                      class="icon icon-plus"></i> {l s='Add' mod='elasticsearch'}</button>
          </td>
        </tr>
      </tfoot>
      <tbody>
